# -*- coding: utf-8 -*-
"""nfl-v5-GridSearch-831.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DW1h-8baY9EvBsT8SHRufdqDHR7eQD1J
"""
...
# 16特徴量に最適化された効率的なグリッド
# param_grid_efficient = {
#     'n_estimators': [100, 200],           # 2つの選択肢
#     'max_depth': [5, 10, None],           # 3つの選択肢
#     'min_samples_split': [2, 5],          # 2つの選択肢
#     'max_features': ['sqrt', None]        # 2つの選択肢
# }
# 0.8301
# 総組み合わせ: 2×3×2×2 = 24通り

# より詳細なグリッド（時間に余裕がある場合）
param_grid_detailed = {
...
print(f"最適なCV AUC: {round(grid_search.best_score_, 4)}")
...
submission.to_csv(PATH + 'v5_GridSearch.csv', index=False)